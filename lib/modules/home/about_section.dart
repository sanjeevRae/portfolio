    ...
    children: [
      ...
      ScrollReveal(
        ...
        child: Padding(
          ...
          child: AutoSizeText(
            "I'm Sanjeev. At my core, I’m a builder who speaks both the language of design and development. I create apps that unite the visual with the technical for intuitive, high-performance results.",
            style: Theme.of(
              context,
      ...
      Row(
        ...
        children: [
          ...
          ScrollReveal(
            ...
            duration: const Duration(milliseconds: 1200),
           child: _buildStatItem(context, 'Hundreds', 'of Components\nBuilt'),
          ),
        ],
      ),
      ...
      Row(
        ...
        children: [
          ScrollReveal(
            delay: const Duration(milliseconds: 1150),
            duration: const Duration(milliseconds: 1200),
            child: _buildStatItem(context, 'Countless', 'Interfaces\nDesigned'),
          ),
          ScrollReveal(
            delay: const Duration(milliseconds: 1200),
            duration: const Duration(milliseconds: 1200),
            child: _buildStatItem(context, '∞', 'Ideas\nTransformed'),
          ),
        ],
      ),
    ],
