...
class _ContactSectionState extends State<ContactSection> {
  ...
  Future<void> _openEmailClient() async {
    try {
      final subject = Uri.encodeComponent('Inquiry');
      ...
      final mailtoUrl = 'mailto:sanzeeprae@gmail.com?subject=$subject&body=$body';
          ...
          const SnackBar(
            content: Row(
              children: [
                ...
                SizedBox(width: 8),
                Expanded(child: Text('Error: Please email me directly at sanzeeprae@gmail.com')),
              ],
            ),
  ...
  Widget _buildContent(ThemeData theme) => Column(
    ...
    children: [
      ...
      Text(
        'Interested in collaborating? Send me a message below or email me directly at sanzeeprae@gmail.com',
